...
const MenuList = () => {
  ...
  const handleSubmit = async () => {
    ...
    // For adding new items, all fields are required
    if (!isEditMode) {
      if (!formData.nama_makanan || !formData.harga || !formData.deskripsi || !formData.foto) {
        toast({
          title: "Error",
          description: "Please fill all required fields when adding a new menu item.",
          variant: "destructive",
        })
        return
      }
    }
    // For editing, at least one field should be filled
    else {
      if (!formData.nama_makanan && !formData.harga && !formData.deskripsi && !formData.foto) {
        toast({
          title: "Error",
              ...
              <Dialog open={openForm} onOpenChange={setOpenForm}>
                ...
                <DialogContent className="w-[95vw] sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
                  ...
                  >
                    ...
                    >
                      <div
                        className={`border-2 border-dashed p-4 sm:p-8 rounded-lg text-center cursor-pointer transition-colors ${
                        ...
                        {formData.foto && (
                          <div className="mt-4">
                            ...
                            <img
                              ...
                              alt="Preview"
                              className="mt-2 max-h-[150px] object-cover rounded-md shadow-sm mx-auto"
                              onLoad={() => {
